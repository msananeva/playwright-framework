...
import { chromium } from 'playwright'; //setting up chromium bc we won't be using configs in this test
...
test.describe("describe block for hooks", () => {
    ...
    test.beforeEach(async () => {
        // create context(settings) for a brower
    ...
    test('Geolocation setting in context and verification', async () => {
        ...
        await page.pause()
        await page.goto('http://the-internet.herokuapp.com/geolocation')
